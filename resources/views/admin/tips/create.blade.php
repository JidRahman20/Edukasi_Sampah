<x-app-layout>
@section('title', 'Tambah Tips Harian')
@section('page-title', 'Tambah Tips Harian')
@section('breadcrumb', 'Beranda / Kelola Tips / Tambah')
...
<div class="card">
    <h2 style="font-size: 18px; font-weight: 600; margin-bottom: 24px;">Tambah Tips Baru</h2>
    ...
    <form action="{{ route('admin.tips.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="image" class="form-label">Gambar Ilustrasi (Maks. 5MB, Opsional)</label>
