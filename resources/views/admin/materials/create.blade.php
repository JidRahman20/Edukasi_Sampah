...
@section('breadcrumb', 'Beranda / Kelola Materi / Tambah')
...
<div class="card">
    <h2 style="font-size: 18px; font-weight: 600; margin-bottom: 24px;">Tambah Materi Baru</h2>
    ...
    <form action="{{ route('admin.materials.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="image" class="form-label">Gambar Header (Opsional)</label>
        ...
        <div class="form-group" style="display:flex; align-items:center; gap:8px;">
            ...
            <label for="is_published" style="font-size:14px; color:var(--text-primary); cursor:pointer;">Langsung Publikasikan Materi Ini</label>
        </div>
